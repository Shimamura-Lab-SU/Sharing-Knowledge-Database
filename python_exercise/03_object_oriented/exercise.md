...
<img src="https://latex.codecogs.com/gif.latex?\large&space;x_n&space;=&space;\frac{a_0}{2}&plus;\sum^{\infty}_{k=1}&space;a_k&space;\sin&space;(k\omega&space;n)&space;&plus;&space;b_k&space;\cos&space;(k\omega&space;n)" title="\large x_n = \frac{a_0}{2}+\sum^{\infty}_{k=1} a_k \sin (k\omega n) + b_k \cos (k\omega n)" />
